...
//    self.view.backgroundColor = [UIColor colorWithHexValue:0x1d1d1d];
    UIImageView * imgView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"tabBg"]];
    [self.view addSubview:imgView];
    self.view.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight;
    
    CGFloat tabBarHeight = 59.0f;
